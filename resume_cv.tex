...
\name{Gioele}{Cicchini}
\address{Via 1799 Repubblica Vastese 4 , Vasto(CH), Italy }
\mobile{(+39) 3284533133}


\email{gioele.cicchini@gmail.com}
%\homepage{www.posquit0.com}
\github{GioeleCicchini}
%\linkedin{posquit0}
\skype{cigio2008}
%\stackoverflow{SOid}{SOname}
%\twitter{@twit}
\linkedin{gioele-cicchini}
%\reddit{reddit account}
%\xing{xing name}
%\extrainfo{test} % Other text you want to include on this line

\position{Software Engineer{\enskip\cdotp\enskip}Software Architect} % Your expertise/fields
\quote{``Software is a great combination between artistry and engineering."} % A quote or statement

\makecvfooter{\today}{Gioele Cicchini}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
\begin{tabular}{cc}
    \includegraphics[width=5cm]{MioProfilo.png} \\
	\makecvheader \\
\end{tabular}
...
\input{cv-sections/Organizational_and_management_skills.tex}
